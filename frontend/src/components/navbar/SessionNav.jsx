    ...
    <nav ref={navbarRef} className="bg-black p-4 flex justify-between items-center sticky top-0 z-10 transition duration-500 ease-linear">
      ...
      <form onSubmit={handleSubmit} className="flex items-center mr-6 ">
          <div className="relative">
            ...
            <button
              type="submit"
              className="absolute inset-y-0 right-0 px-4 py-1 border border-white bg-amber-500 rounded-full text-white font-semibold"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
        ...
        <div className="relative">
          <button onClick={toggleDropdown} className="flex items-center bg-amber-500 px-4 py-2 rounded-full text-white font-semibold">
