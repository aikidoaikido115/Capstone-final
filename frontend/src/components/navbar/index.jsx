    ...
    <nav ref={navbarRef} className="bg-black p-4 flex justify-between items-center sticky top-0 z-10 transition duration-500 ease-linear">
      ...
      <form onSubmit={handleSubmit} className="flex items-center mr-6 ">
          <div className="relative">
            ...
            <button
              type="submit"
              className="absolute inset-y-0 right-0 px-4 py-1 border border-white bg-amber-500 hover:bg-amber-600 rounded-full text-white font-semibold"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
        ...
        <Link to="/login">
          <button className="flex items-center mr-4 bg-amber-500 hover:bg-amber-600 px-4 py-2 rounded-full text-white font-semibold hover:scale-105">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
              stroke="currentColor" className="w-8 h-8 mr-2">
