...
const PopupUpdateAnime = ({ onSubmit, genre, title}) => {
    ...
    return (
        <div>
        <button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 hover:scale-110 hover:z-10"
        onClick={togglePopup}
        >Edit
        </button>
        {isOpen && (
            ...
            >
                ...
                <label>
                    <span className="text-base text-blue-500">Edit synopsis</span>
                    <textarea
                    className="w-full text-black border border-gray-300 rounded-md px-3 py-2 mb-4 focus:outline-none focus:border-blue-500"
                ...
                <label>
                    <span className="text-base text-blue-500">Edit rating (1-10)</span>
                    <input
                        className="w-full text-black border border-gray-300 rounded-md px-3 py-2 mb-4 focus:outline-none focus:border-blue-500"
                        type="number"
                        step="0.1"
                ...
                <label className="flex flex-col gap-1">
                    <div className="flex flex-col mb-5 gap-1">
                        <span className="text-base text-blue-500">Edit anime video file <span className="text-red-500">(optional)</span></span>
                ...
                <div className="flex flex-col mb-1">
                    <h1 className="text-base text-blue-500 mb-0.5">Edit anime status</h1>
                    <label className="flex items-center mb-0.5 gap-1">
                    <input
                        type="radio"
                        value="true"
                ...
                <label>
                    <div className="mb-3">
                        ...
                        <span className="text-base text-red-500">(Use , to separate the episode names in case of adding multiple chapter video files.)</span></span>
                        <input
                            className="w-full text-black border border-gray-300 rounded-md px-3 py-2 mb-4 focus:outline-none focus:border-blue-500"
                            type="text"
                ...
                <div className="flex justify-between">
                    <button
                        className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:animate-pulse hover:animate-infinite hover:animate-duration-[1500ms] hover:animate-delay-1000 hover:animate-ease-linear"
                        onClick={togglePopup}
                    >
                        Cancel
                    </button>
                    <button
                        className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:animate-pulse hover:animate-infinite hover:animate-duration-[1500ms] hover:animate-delay-1000 hover:animate-ease-linear"
                        type="submit"
                    >
                        Update
                    </button>
