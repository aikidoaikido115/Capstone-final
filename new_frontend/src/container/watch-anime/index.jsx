                        ...
                        <div className="w-full md:w-3/4 p-4">
                            ...
                            <div className="flex items-center justify-between py-2">
                                <div className="flex justify-between ml-1 w-full">
                                    ...
                                    <button
                                      className={"flex items-center p-2 border-2 hover:animate-pulse animate-once transition-all duration-300 hover:scale-110 hover:z-10" + buttonBase}
                                    ...
                                    <div className='w-2/5 flex justify-between items-center gap-5'>
                                        ...
                                        <div class="relative group flex justify-center items-center transition-all duration-300 hover:scale-110 hover:z-10">
                                            <Switch
                        ...
                        <div className="w-full md:w-1/4 p-4">
                            ...
                            <div className="grid grid-cols-4 gap-4 w-4/5">
                                ...
                                {episode_number_array.map((element, index) => (
                                    <button
                                    key={element}
                                    className="text-center bg-amber-500 rounded-lg p-1 my-2 transition-all duration-300 hover:scale-110 hover:z-10"
                            ...
                            <div>
                                <h2 className={"text-xl font-bold " + titleColor + " mt-8 mb-4"}>Recommended For You</h2>
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        className="w-32 h-20 object-cover border-2 border-amber-500 rounded-2xl transition-all duration-300 hover:scale-110 hover:z-10" />
                                        <div className='w-1/3'>
                                            <h3
                            ...
                            <h2 className={"text-xl font-bold " + titleColor + " mt-8 mb-4"}>Recently Added Anime</h2>
                            <div className="space-y-4">
