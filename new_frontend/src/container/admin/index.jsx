...
function Admin() {
    ...
    // true จะเป็น logo premium false จะเป็นโลโก้ธรรมดา
                ...
                axios.get(`http://localhost:8000/`)
                    ...
                    fetchArrayBasicInfo()
                        .then(anime =>{
                            ...
                            //วิธีนี้ได้ผล แต่ infinite loop ไม่เอาเดี๋ยวเว็บล่ม
                            // forceUpdate(Math.random());
                        })
    ...
    return (
        ...
        <div className="bg-black">
            ...
            <div className="grid grid-cols-6 gap-4">
                ...
                <div key={title} className="bg-gray-800 rounded-md p-4 mb-8 flex flex-col justify-between">
                    ...
                    <button className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-300 hover:scale-110 hover:z-10"  onClick={() => { if (window.confirm("Are you sure you want to delete this anime?")) {handleDeleteAnime(array_basic_data.AnimeTitle[array_basic_data.AnimeTitle.length - 1 - index]); } }}>Delete</button>
                ...
                {/* Add button */}
                <div className="bg-gray-800 rounded-md p-4 mb-8 flex flex-col justify-center items-center">
